...
window.confirmTransfer = async () => {
    ...
    if (!selectedTransferLicense || !selectedTransferUser) {
        ...
        openPapeletaModal("ERROR", false, null, "", "Debes seleccionar una licencia y un usuario destino");
        return;
    }
    ...
    if (!licenseId) {
        openPapeletaModal("ERROR", false, null, "", "ID de licencia no válido");
        return;
    }
    
    openPapeletaModal("CONFIRMAR TRANSFERENCIA", false, async () => {
        ...
        try {
            ...
            openPapeletaModal(" EXITO", false, null, "", `Licencia "${licenseResource}" transferida correctamente a ${targetUsername}`);
